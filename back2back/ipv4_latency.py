...
class Example:
    ...
    def run(self):
        ...
        # create a latency-enabled trigger.
        # A trigger is an object which receives data.  The Basic trigger just
        # counts packets, a LatencyBasic trigger analyzes the timestamps
        # embedded in the received frame.
        ...
        # start the traffic and clear the latency trigger.
        ...
        return [tx_frames, rx_frames,
                latency_min, latency_avg, latency_max, jitter]

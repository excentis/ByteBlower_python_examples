"""
Basic IPv4 with out-of-sequence detection example for the
...
class Example:
    ...
    def run(self):
        ...
        # collect the frame header info.  We need to provide
        # the Layer2 (ethernet) and Layer3 (IPv4) addresses.
        ...
        # Enable sequence tagging for this frame.
        # The frame frame contents will be altered so it contains a
        # sequence number.
        frame_tag = frame.FrameTagSequenceGet()
        frame_tag.Enable(True)

        # create a sequence-enabled trigger.
        # A trigger is an object which receives data.  The Basic trigger just
        # counts packets, an OutOfSequenceBasic trigger analyzes the sequence
        # numbers embedded in the received frame.
        ...
        # start the traffic, clear the sequence trigger.
        ...
        for iteration in range(1, int(duration_s)):
            ...
            # The Refresh method will synchronize the server data with the
            # client.
